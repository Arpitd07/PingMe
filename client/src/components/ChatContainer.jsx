...
const ChatContainer = () => {
  ...
  return selectedUser ? (
    <div className="h-full flex flex-col relative backdrop-bl-lg">
      {/* Header */}
        ...
        {messages.map((msg, index) => (
          ...
          >
            {msg.image ? (
              ...
              <p
                className={`p-2 max-w-[200px] md:text-sm font-light rounded-lg mb-8 break-all bg-gradient-to-br from-blue-400/30 to-blue-500/20 text-gray-300 ${
      ...
      {/* Input field */}
      <div className="flex items-center gap-3 p-3 border-t border-gray-600">
